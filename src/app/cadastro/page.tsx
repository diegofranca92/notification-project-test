  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-blue-500 to-indigo-700">
      <form onSubmit={handleLogin} className="bg-white p-8 shadow-lg rounded-lg w-96">
        <h1 className="text-3xl font-bold mb-6 text-center text-gray-700">Bem-vindo de Volta</h1>
        <button
          type="button"
        ...
        >
          <img src="/google-icon.svg" alt="Google" className="w-5 h-5" /> Login com Google
        </button>
